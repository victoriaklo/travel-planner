...
// put the click handler here instead of html

const button = document.querySelector('#restaurants-btn'); // querySelector is null??
console.log(button)
// button prints null, doesn't read the addEventListener
